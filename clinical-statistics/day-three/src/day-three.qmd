...
-   2,000: I have a website with over 2,000 separate pages.
...
Back in 1998, I started writing on the web. I would create a page or two each week. Eventually, it grew to over 2,000 pages. The quality of the site is uneven, but there's something for everyone. My major topics are data analysis, research ethics, and evidence-based medicine.

The site is currently undergoing a major re-organization.
:::
...
![Mean ages](../images/titanic-means.png){#fig-titanic-means fig-align="left"}
95% CI (-0.3, 3.8)
...
![Odds for winning election to U.S. president in 2024](../images/presidential-odds.png){#fig-multiplicative-trend-ga fig-align="left"}
...
![Additive trend in log odds](../images/additive-log-odds-ga.gif){#fig-multiplicative-odds-ga fig-align="left"}
...
![S-shaped curve](../images/s-shaped-curve.gif){#fig-odds-converted fig-align="left"}
...
## Examples of logistic regression from the literature