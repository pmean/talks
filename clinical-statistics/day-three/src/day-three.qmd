...
The page on chi-squared analysis for the Titanic data ended a bit abruptly. The hazard function slides did not turn out properly. Maybe spend a bit more time on intuition.

## Re-introduce yourself

Here's one more interesting number about myself

-   10,000: My son's latest "toy", a 2008 Hummer, cost $10,000.I have a 21 year old son.
...
-   Slope for x1: estimated average change in y when x1 increases by one unit **and x2 is held constant**.
...
-   Github site [github.com/pmean](https://github.com/pmean)
    -   [talks](https://github.com/pmean/talks):  clinical-statistics, sample-size-justification, power
    -   [classes](https://github.com/pmean/classes): clinical-research-methodology, survival-models
    -   [papers-and-presentations](https://github.com/pmean/papers-and-presentations): illustrating-linear-regression, power
-   websites
    -   [www.pmean.com](http://www.pmean.com/)
        -   [original website](http://www.pmean.com/original_site.html), [blog](http://www.pmean.com/original_site.html), [new website](http://new.pmean.com/index.html)
