...
![Image of a haemocytometer](sperm-count.png){#fig-who-2021}
...
![Titanic data: counts of survival by gender](titanic-counts.png){#fig-counts}
...
![Titanic data with row percentages](titanic-row-percents.png){#fig-row-percents}
...
![Titanic data with cell percentages](titanic-cell-percents.png){#fig-cell-percents}
...
::: columns
::: {.column width="50%"}
![Titanic passenger class counts](titanic-passenger-class-counts.png){#fig-titanic-pclass}
:::

::: {.column width="50%"}
![Titanic child counts](titanic-child-counts.png){#fig-titanic-child}
:::
:::
...
![Cartoon image of Professor Mean](professor-mean.png){#fig-professor-mean}
...
![Road with a median strip](road-median.jpg){#fig-road-median}
...
![Excerpt from Gould 1985 publication](gould-1985.png){#fig-gould-1985}
...
![Bridge and McKenzie 2001](bridge-2001.png){#fig-bridge-2001}
...
![Tosato et al 2021](tosato-2021.png){#fig-tosato-2021}
...
![Tosato et al 2021](ielapi-2021.png){#fig-tosato-2021}
...
![Chen et al 2019](chen-2019.png){#fig-chen-2019}
...
![Illustration of the 75th percentile](illustrate-percentiles.png){#fig-illustrate-percentiles}
...
![Bimodal histogram](bimodal-histogram.png){#fig-bimodal-histogram}
...
![Skewed histogram](skewed-histogram.png){#fig-skewed-histogram}
...
![Uniform histogram](uniform-histogram.png){#fig-uniform-histogram}
...
![Heavy-tailed histogram](heavy-tailed-histogram.png){#fig-heavy-tailed-histogram}
...
![Bell-shaped histogram](normal-histogram.png){#fig-normal-histogram}
...
![Percentage within one s](one-s-histogram.png){#fig-one-s-histogram}
...
![Percentage within two s](two-s-histogram.png){#fig-two-s-histogram}
...
![Percentage within three s](three-s-histogram.png){#fig-three-s-histogram}
...
![Lin et al 2022](lin-2022.png){#fig-lin-2022}
...
![Excerpt from Table 1 of Lin et al 2022: ages](lin-2022-ages.png){#fig-lin-2022-ages}
...
![Excerpt from Table 1 of Lin et al 2022: CCI](lin-2022-cci.png){#fig-lin-2022-cci}
...
![Excerpt from Table 1 of Lin et al 2022: PHQ-2](lin-2022-phq.png){#fig-lin-2022-phq}
...
![Color combinations](primary-colors.jpg){#fig-primary-colors}
...
![Red plus green](red-plus-green.png){#fig-red-plus-green}
![Red plus blue](red-plus-blue.png){#fig-red-plus-blue}

## Color combinations: magenta

![Green plus blue](green-plus-blue.png){#fig-red-plus-green}

## The color cube

![Illustration of the color cube](color-cube.png){#fig-color-cube}

## The color cylinder

![Color cylinder](hsv-colors.png){#fig-equi-spaced-hues}

## Rainbow

![ ](pure-rainbow.png){#fig-pure-rainbow}

## Harsh contrasts

![](harsh-contrasts.png){#fig-harsh-contrasts}

## Lighter rainbow

![](lighter-rainbow.png){#fig-lighter-rainbow}
## Darker rainbow

![](darker-rainbow.png){#fig-darker-rainbow}

## Gentler contrasts

![](gentler-contrasts.png){#fig-gentler-contrasts}


## Equally spaced hues

![Color choices for nominal data](equi-spaced-hues.png){#fig-equi-spaced-hues}



##

![Illustration of the rainbow gradient](rainbow-gradient.png){#fig-rainbow-gradient}

##

![Clothing mistake: using too many colors](bold-clothes.png){#fig-bold-clothes}

##

![ADvertisement with a single red umbrella](red-umbrella.png){#red-umbrella}
...
![Use of color to highlight a single individual](orange-mac.jpg){#fig-orange-mac}
...
![How many "5's" are in this figure?](count-fives-1.png){#fig-count-fives-1}
...
![Repeat question. How many "5's" are in this figure?](count-fives-2.png){#fig-count-fives-2}
