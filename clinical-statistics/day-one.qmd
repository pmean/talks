...
::: notes
I want each of you to share an interesting number about yourself.
:::
...
![Titanic data: counts of survival by gender](titanic-counts.png){#fig-counts fig-align="left"}
...
![Titanic data with column percentages](titanic-column-percents.png){#fig-column-percents}
...
![Titanic data with row percentages](titanic-row-percents.png){#fig-row-percents fig-align="left"}
...
![Titanic data with cell percentages](titanic-cell-percents.png){#fig-cell-percents fig-align="left"}
...
![Excerpt from Gould 1985 publication](gould-1985.png){#fig-gould-1985 fig-align="left"}
...
![Exceprt from Bridge and McKenzie 2001, PMID: 11405531](bridge-2001.png){#fig-bridge-2001 fig-align="left"}
...
ggsave("bimodal-histogram.png")
```

![Bimodal histogram](bimodal-histogram.png){#fig-bimodal-histogram fig-align="left"}
...
ggsave("skewed-histogram.png")
```

![Skewed histogram](skewed-histogram.png){#fig-skewed-histogram fig-align="left"}
...
ggsave("uniform-histogram.png")
```

![Uniform histogram](uniform-histogram.png){#fig-uniform-histogram fig-align="left"}
...
ggsave("heavy-tailed-histogram.png")
```

![Heavy-tailed histogram](heavy-tailed-histogram.png){#fig-heavy-tailed-histogram fig-align="left"}
...
ggsave("normal-histogram.png")
```

![Bell-shaped histogram](normal-histogram.png){#fig-normal-histogram fig-align="left"}
...
ggsave("one-s-histogram.png")
```

![Percentage within one s](one-s-histogram.png){#fig-one-s-histogram fig-align="left"}
...
ggsave("two-s-histogram.png")
```

![Percentage within two s](two-s-histogram.png){#fig-two-s-histogram fig-align="left"}
...
ggsave("three-s-histogram.png")
```

![Percentage within three s](three-s-histogram.png){#fig-three-s-histogram fig-align="left"}
...
![Lin et al 2022](lin-2022.png){#fig-lin-2022 fig-align="left"}
...
![Excerpt from Table 1 of Lin et al 2022: ages](lin-2022-ages.png){#fig-lin-2022-ages fig-align="left"}
...
![Excerpt from Table 1 of Lin et al 2022: CCI](lin-2022-cci.png){#fig-lin-2022-cci fig-align="left"}
...
![Excerpt from Table 1 of Lin et al 2022: PHQ-2](lin-2022-phq.png){#fig-lin-2022-phq fig-align="left"}
...
![Tosato et al 2021](tosato-2021.png){#fig-tosato-2021 fig-align="left"}
...
![Ielapi et al 2021](ielapi-2021.png){#fig-ielapi-2021 fig-align="left"}
...
![Color combinations](primary-colors.jpg){#fig-primary-colors fig-align="left"}
...
![Red plus green equals yellow](red-plus-green.png){#fig-red-plus-green fig-align="left"}

## 

![Red plus blue equals magenta](red-plus-blue.png){#fig-red-plus-blue fig-align="left"}

## 

![Green plus blue equals cyan](green-plus-blue.png){fig-align="left"}

## The color cube

![Illustration of the color cube](color-cube.png){#fig-color-cube fig-align="left"}

## The color cylinder

![Color cylinder](hsv-colors.png){#fig-hsv-colors fig-align="left"}

## Rainbow

![](pure-rainbow.png){#fig-pure-rainbow fig-align="left"}

## Harsh contrasts

![](harsh-contrasts.png){#fig-harsh-contrasts fig-align="left"}

## Lighter rainbow

![](lighter-rainbow.png){#fig-lighter-rainbow fig-align="left"} \## Darker rainbow

![](darker-rainbow.png){#fig-darker-rainbow fig-align="left"}

## Gentler contrasts

![](gentler-contrasts.png){#fig-gentler-contrasts fig-align="left"}

## Equally spaced hues

![Color choices for nominal data](equi-spaced-hues.png){#fig-equi-spaced-hues fig-align="left"}

## 

![Illustration of the rainbow gradient](rainbow-gradient.png){#fig-rainbow-gradient fig-align="left"}

## 

![Clothing mistake: using too many colors](bold-clothes.png){#fig-bold-clothes fig-align="left"}

## 

![ADvertisement with a single red umbrella](red-umbrella.png){#red-umbrella fig-align="left"}
...
![Use of color to highlight a single individual](orange-mac.jpg){#fig-orange-mac fig-align="left"}
...
![How many "5's" are in this figure?](count-fives-1.png){#fig-count-fives-1 fig-align="left"}
...
![Repeat question. How many "5's" are in this figure?](count-fives-2.png){#fig-count-fives-2 fig-align="left"}
