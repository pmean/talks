...
-   Two alternatives
    ...
    -   Bayesian analysis
-   What do do when no research hypothess
...
## Layout the ECMO and control probabilities

![Empty table for prior probabilities](prior-shell.png){#fig-prior-shell fig-align="left"}

## Place part of the probability on the diagonal

![Table with diagonal priors](prior-diagonal.png){#fig-prior-diagonal fig-align="left"}

## Place part of the probabilty below the diagonal

![Table with lower triangle of prior probabilities](prior-lower.png){#fig-prior-lower fig-align="left"}

![Table with upper triangle of prior probabilities](prior-upper.png){#fig-prior-upper fig-align="left"}

## Prior table

![Complete table of prior probabilities](prior.png){#fig-prior fig-align="left"}

## Calculate likelihood for each ECMO/control probability

![Table of likelihoods](likelihood.png){#fig-likelihood fig-align="left"}

## Multiply prior and likelihood

![Product of prior and likelihood](product.png){#fig-product fig-align="left"}

## Divide by sum to get posterior

![Table of prior probabilities](posterior.png){#fig-posterior fig-align="left"}

## Posterior probability of equality

![Table of prior probabilities](posterior-equality.png){#fig-posterior-equality fig-align="left"}

## Posterior probability of 20% or greater superiority

![Table of superiority posterior probabilities](posterior-superiority.png){#fig-posterior-equality fig-align="left"}
