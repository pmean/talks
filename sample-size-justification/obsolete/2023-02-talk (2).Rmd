...
author: "Steve Simon, https://github.com/pmean/papers-and-presentations/blob/master/sample-size-justification/2023-02-talk.pdf"
source: "New"
...
The parameter you want to compute is left as NULL. So if you want a sample size that produces 80% power, leave n as NULL. If you want to estimate power when the sample size is 50 per group, set power to NULL.
